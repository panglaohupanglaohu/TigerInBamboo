...
Color-only target revision, based on vanguard-battle-v1. Original files are retained read-only.
...
Actual fresh-GLB before/after images use identical cameras, illumination and color management in artifacts/pipeline/vanguard-color-v2. Target: assets/concepts/vanguard-trooper-target-v1.png. SOCCO images are empty-craft color comparisons; no old-colored transport crew are included.
