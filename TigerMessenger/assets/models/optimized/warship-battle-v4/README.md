...
Status: geometry_and_motion_checked_candidate. Runtime integrated: **false**. Full battle ready: **false**.
...
Images: ../../../../artifacts/pipeline/warship-battle-v4/glb-frame51-three-quarter.png and glb-frame51-top.png. V4 includes glb-eye-closeup.png. Same V2-calibrated camera and light for both rounds.

Build: tools/pipeline/build_warship_two_pass_blender.py -- --version 4
Validate: tools/pipeline/validate_warship_two_pass_blender.py -- --version 4
