...
export function buildMessenger() {
  ...
  addOutline(head, OUTLINE.character);
  group.add(head);
  ...
  addOutline(earL, OUTLINE.characterDetail);
  group.add(earL);
  ...
  addOutline(legL, OUTLINE.characterDetail);
  group.add(legL);
  const legR = new THREE.Mesh(legGeo, dark);
  legR.position.set(0.14, 0.58, 0);
  legR.castShadow = true;
  addOutline(legR, OUTLINE.characterDetail);
  group.add(legR);
  ...
  addOutline(armL, OUTLINE.characterDetail);
  group.add(armL);
  const armR = new THREE.Mesh(armGeo, cloth);
  armR.position.set(0.38, 1.15, 0);
  armR.castShadow = true;
  addOutline(armR, OUTLINE.characterDetail);
  group.add(armR);
