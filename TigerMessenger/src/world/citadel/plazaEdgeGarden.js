...
import baked from '../../../assets/models/optimized/citadel-plaza-edge/plazaEdgeR01.js';
...
export function buildPlazaEdgeGarden(){
 ...
 const lines=[[[45.2,88.12],[80.62,88.12]],[[45.2,84.3],[45.2,88.12]],[[80.62,79.6],[80.62,88.12]]];lines.forEach(([a,b])=>course(a,b));
 for(const [x,z]of [[45.2,88.12],[53.5,88.12],[63,88.12],[72,88.12],[80.62,88.12],[45.2,84.3],[80.62,79.6]]){box('plaza-parapet-pier',x,4.64,z,.92,1.28,.92);box('plaza-pier-cap',x,5.32,z,1.04,.16,1.04,cap);}
 ...
 root.userData.layout={lines,beds,trees,entrance:{x:45.2,z:82,clearWidth:3.5},plazaFloor:4,ringCenter:[59,76],ringRadius:7.4};
 return root;
}
