...
SOURCE = ROOT / "assets/models/originals/supplemental/blender-r3/scoutAircraft.blend"
OUT = ROOT / "artifacts/pipeline/scoutAircraft"
...
report = {"source": str(SOURCE.relative_to(ROOT)), "sourceSha256": before_hash,
 ...
 "render": "artifacts/pipeline/scoutAircraft/original.png", "renderer": "Cycles", "samples":40,
