...
const out=new URL('../../artifacts/pipeline/citadel-harbor-curtain/',import.meta.url);await mkdir(out,{recursive:true});
...
const curtain=front.getObjectByName("citadel-front-harbor-curtain");result.curtain={...curtain.userData,parts:curtain.children.length};
