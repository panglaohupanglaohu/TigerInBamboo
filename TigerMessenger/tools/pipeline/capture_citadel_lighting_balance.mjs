...
try{
 ...
 const report=await page.evaluate(()=>{
  ...
  return {lighting:city.getObjectByName('citadel-new-city-lighting').userData.manifest,...root.userData.facadeWfc,openingHits:cast(49.1,21.3),wallHits:cast(50.1,21.3),visible:root.visible,archivedCrown:!city.getObjectByName('west-city-crown').visible};
 });
 ...
 await writeFile(new URL('../../godot/data/citadel-new-city-lighting.json',import.meta.url),JSON.stringify(report.lighting,null,2));
