...
for(const [name,data]of Object.entries(images))await writeFile(new URL('../../artifacts/pipeline/citadel-master-terrain/baseline-'+name+'.png',import.meta.url),Buffer.from(data.split(',')[1],'base64'));
