...
const curtain=front.getObjectByName("citadel-front-harbor-curtain");result.curtain={...curtain.userData,parts:curtain.children.length};result.planting=city.getObjectByName("citadel-retaining-planting").userData.planting;
