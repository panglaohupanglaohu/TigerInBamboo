...
COLORS=['403a31','51483b','615544','746854','887a65','a29580','b2a691']
...
for sid in ['n8','n9']:
 ...
 for poly in mesh.polygons:
  ...
  groove=math.cos(theta*4+.12*math.sin(p.z*1.25))
...
base_report=json.loads((EV/'report.json').read_text());full=next(r for r in base_report['renders'] if r['state']=='v2' and r['view']=='full');center=Vector(full['target']);span=full['ortho']/1.10;direction=Vector((3,-5,1.7)).normalized()
...
report={'seed':811,'scope':'Single seed 811 actual Blender v2 geometry plus exported face-color aging. No Web/Godot or batch integration.',
 ...
 'iteration':2,'physicalBarkNoiseRemoved':True,
