...
assert 'Roman Armor V2 Refined' not in bpy.data.scenes
scene=bpy.data.scenes.new('Roman Armor V2 Refined');bpy.context.window.scene=scene
...
add('Waist_Belt',v,f)
for i in range(10):
 a=2*math.pi*i/10;box('Helmet_Galea',(.062*math.cos(a),.015,.043*math.sin(a)),(.010,.012,.009))
...
for id in ['n3','n7','n11','n13','n15','n18','n21','n24','n27']:
 ...
 if id in ['n11','n13','n15']:
  for vertex in vv:vertex.y-=.018
