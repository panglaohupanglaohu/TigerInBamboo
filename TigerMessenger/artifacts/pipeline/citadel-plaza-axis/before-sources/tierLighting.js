...
export function applyCitadelTierLighting(castle){
 ...
 const newSpecs=[
 {id:'main-gate',position:[60,23,21],color:0xffac58,intensity:220,radius:24,godotEnergy:80},
 {id:'plaza',position:[59,8,70],color:0xffb965,intensity:70,radius:18,godotEnergy:15},
