...
func run()->void:
    ...
    w.camera.global_position=frame*Vector3(99,49,69)
    w.camera.look_at(frame*Vector3(61,32,-1),frame.basis.y.normalized())
    w.camera.fov=43
    ...
    var out="res://../artifacts/pipeline/citadel-faceted-towers/"
