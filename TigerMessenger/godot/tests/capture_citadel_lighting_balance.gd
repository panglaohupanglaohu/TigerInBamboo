...
func run()->void:
    ...
    root.get_texture().get_image().save_png("res://../artifacts/pipeline/citadel-lighting-balance/godot-night.png")
    print("Captured actual Godot citadel, current imported facade, corresponding authored camera")
