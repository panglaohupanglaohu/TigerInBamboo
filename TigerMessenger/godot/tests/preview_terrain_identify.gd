...
func run()->void:
    ...
    for mesh in w.model.find_children("citadel-oskar-grid-mountain-surface","MeshInstance3D",true,false):
    ...
    for night in [false,true]:
        ...
        root.get_texture().get_image().save_png(out+("godot-identify-night.png" if night else "godot-identify-day.png"))
