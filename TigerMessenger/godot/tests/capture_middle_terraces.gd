...
func run()->void:
    ...
    w.camera.global_position=frame*Vector3(100,35,99)
    w.camera.look_at(frame*Vector3(61,13,33),frame.basis.y.normalized())
    w.camera.fov=48
    ...
    var out="res://../artifacts/pipeline/citadel-middle-terraces/"
